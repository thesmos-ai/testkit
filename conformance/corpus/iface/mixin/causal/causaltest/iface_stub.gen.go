...
type MixedStoreStub struct {
	*stub.MethodStub[MixedStoreCall]
	...
	fn       func(context.Context, causal.Value) (causal.Value, error)
...
func (s *MixedStoreStub) Returns(result causal.Value, err error) *MixedStoreStub {
...
func (s *MixedStoreStub) Func(fn func(context.Context, causal.Value) (causal.Value, error)) *MixedStoreStub {
	s.fn = fn
	return s
}
...
type MixedGetStub struct {
	*stub.MethodStub[MixedGetCall]
	...
	fn       func(context.Context, string) (causal.Value, error)
...
// override and an injected fault both take precedence over it.
func (s *MixedGetStub) Returns(result causal.Value, err error) *MixedGetStub {
...
// arguments. An injected fault still takes precedence.
func (s *MixedGetStub) Func(fn func(context.Context, string) (causal.Value, error)) *MixedGetStub {
	s.fn = fn
	return s
}
...
func MixedStubDelegateTo(impl causal.Mixed) MixedStubOption {
...
func WithMixedStore(fn func(context.Context, causal.Value) (causal.Value, error)) MixedStubOption {
...
// time, for the common case of configuring one method and taking the
// defaults for the rest.
func WithMixedGet(fn func(context.Context, string) (causal.Value, error)) MixedStubOption {
...
var _ causal.Mixed = (*MixedStub)(nil)
...
func (s *MixedStoreStub) invoke(ctx context.Context, v causal.Value) func() MixedStoreReturn {
	if s.fn == nil {
		return nil
	}
...
// restated per method.
func (s *MixedStub) Store(ctx context.Context, v causal.Value) (causal.Value, error) {
...
// resolves a call the same way and the ordering is tested once rather than
// restated per method.
func (s *MixedStub) Get(ctx context.Context, key string) (causal.Value, error) {
...
// testkit:provenance 4ad25da09c2fb2c070208bb8e87e79446c7de603f099f48c4108435e5f278eed
