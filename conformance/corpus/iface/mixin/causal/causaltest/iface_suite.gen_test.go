...
func TestMixedProofs(t *testing.T) {
	t.Parallel()
	prove.All(t,
		causaltest.MixedSuite.Suite(causaltest.DefaultMixedFixture()).Checks,
		mixedProofs())
}
...
func mixedProofs() prove.Defects[causaltest.Mixed] {
	ix := causaltest.MixedSuite.Checks
	return prove.Defects[causaltest.Mixed]{
...
func TestMixedInvariants(t *testing.T) {
	...
	s := causaltest.MixedSuite.Suite(causaltest.DefaultMixedFixture())
	...
	suite.VerifyIndex(t, "Mixed",
		causaltest.MixedSuite.Checks.All(), s.IDs())
