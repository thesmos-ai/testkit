...
type MixedStoreCall struct {
	Ctx    context.Context
	V      readyourwrites.Value
	Result readyourwrites.Value
	Err    error
}
...
type MixedStoreStub struct {
	*stub.MethodStub[MixedStoreCall]
	...
	fn       func(context.Context, readyourwrites.Value) (readyourwrites.Value, error)
...
func (s *MixedStoreStub) Returns(result readyourwrites.Value, err error) *MixedStoreStub {
...
func (s *MixedStoreStub) Func(fn func(context.Context, readyourwrites.Value) (readyourwrites.Value, error)) *MixedStoreStub {
	s.fn = fn
	return s
}
...
type MixedGetStub struct {
	*stub.MethodStub[MixedGetCall]
	...
	fn       func(context.Context, string) (readyourwrites.Value, error)
...
// override and an injected fault both take precedence over it.
func (s *MixedGetStub) Returns(result readyourwrites.Value, err error) *MixedGetStub {
...
// arguments. An injected fault still takes precedence.
func (s *MixedGetStub) Func(fn func(context.Context, string) (readyourwrites.Value, error)) *MixedGetStub {
	s.fn = fn
	return s
}
...
func MixedStubDelegateTo(impl readyourwrites.Mixed) MixedStubOption {
...
func WithMixedStore(fn func(context.Context, readyourwrites.Value) (readyourwrites.Value, error)) MixedStubOption {
...
// time, for the common case of configuring one method and taking the
// defaults for the rest.
func WithMixedGet(fn func(context.Context, string) (readyourwrites.Value, error)) MixedStubOption {
...
var _ readyourwrites.Mixed = (*MixedStub)(nil)
...
func (s *MixedStoreStub) invoke(ctx context.Context, v readyourwrites.Value) func() MixedStoreReturn {
	if s.fn == nil {
		return nil
	}
...
// restated per method.
func (s *MixedStub) Store(ctx context.Context, v readyourwrites.Value) (readyourwrites.Value, error) {
...
// resolves a call the same way and the ordering is tested once rather than
// restated per method.
func (s *MixedStub) Get(ctx context.Context, key string) (readyourwrites.Value, error) {
...
// testkit:provenance f0a382b5439fe0077eff863798d6bf8bbab29036974ee296d5bf6c2885ef49a1
