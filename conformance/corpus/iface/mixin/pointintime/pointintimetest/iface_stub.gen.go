...
type MixedStoreStub struct {
	*stub.MethodStub[MixedStoreCall]
	...
	fn       func(context.Context, pointintime.Value) error
...
func (s *MixedStoreStub) Func(fn func(context.Context, pointintime.Value) error) *MixedStoreStub {
	s.fn = fn
	return s
}
...
type MixedGetStub struct {
	*stub.MethodStub[MixedGetCall]
	...
	fn       func(context.Context, string) (pointintime.Value, error)
...
// override and an injected fault both take precedence over it.
func (s *MixedGetStub) Returns(result pointintime.Value, err error) *MixedGetStub {
...
// arguments. An injected fault still takes precedence.
func (s *MixedGetStub) Func(fn func(context.Context, string) (pointintime.Value, error)) *MixedGetStub {
	s.fn = fn
	return s
}
...
func MixedStubDelegateTo(impl pointintime.Mixed) MixedStubOption {
...
func WithMixedStore(fn func(context.Context, pointintime.Value) error) MixedStubOption {
...
// time, for the common case of configuring one method and taking the
// defaults for the rest.
func WithMixedGet(fn func(context.Context, string) (pointintime.Value, error)) MixedStubOption {
...
var _ pointintime.Mixed = (*MixedStub)(nil)
...
func (s *MixedStoreStub) invoke(ctx context.Context, v pointintime.Value) func() MixedStoreReturn {
	if s.fn == nil {
		return nil
	}
...
// restated per method.
func (s *MixedStub) Store(ctx context.Context, v pointintime.Value) error {
...
// resolves a call the same way and the ordering is tested once rather than
// restated per method.
func (s *MixedStub) Get(ctx context.Context, key string) (pointintime.Value, error) {
...
// testkit:provenance f2b8fbd81bcbd922e4b456d96843cf0bf75e39d6eaf8c5b0f87ec0f920d536fc
