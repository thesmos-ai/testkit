...
func TestMixedProofs(t *testing.T) {
	t.Parallel()
	prove.All(t,
		pointintimetest.MixedSuite.Suite(pointintimetest.DefaultMixedFixture()).Checks,
		mixedProofs())
}
...
func mixedProofs() prove.Defects[pointintimetest.Mixed] {
	ix := pointintimetest.MixedSuite.Checks
	return prove.Defects[pointintimetest.Mixed]{
...
// testkit:provenance 8f97b31918dff6b131590f08711b3a8bc3055aaddd64ac3e4551c049c6ccbef6
