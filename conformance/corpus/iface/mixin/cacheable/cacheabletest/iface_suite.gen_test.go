...
func TestMixedProofs(t *testing.T) {
	t.Parallel()
	prove.All(t,
		cacheabletest.MixedSuite.Suite(cacheabletest.DefaultMixedFixture()).Checks,
		mixedProofs())
}
...
func mixedProofs() prove.Defects[cacheabletest.Mixed] {
	ix := cacheabletest.MixedSuite.Checks
	return prove.Defects[cacheabletest.Mixed]{
...
func TestMixedInvariants(t *testing.T) {
	...
	s := cacheabletest.MixedSuite.Suite(cacheabletest.DefaultMixedFixture())
	...
	suite.VerifyIndex(t, "Mixed",
		cacheabletest.MixedSuite.Checks.All(), s.IDs())
