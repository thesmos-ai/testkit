...
func TestMixedProofs(t *testing.T) {
	t.Parallel()
	prove.All(t,
		partitiontest.MixedSuite.Suite(partitiontest.DefaultMixedFixture()).Checks,
		mixedProofs())
}
...
func mixedProofs() prove.Defects[partitiontest.Mixed] {
	ix := partitiontest.MixedSuite.Checks
	return prove.Defects[partitiontest.Mixed]{
