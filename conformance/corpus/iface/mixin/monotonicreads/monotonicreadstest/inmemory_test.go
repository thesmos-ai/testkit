...
func TestMixedChecksCanFail(t *testing.T) {
	...
	monotonicreadstest.ProveMixed(t, mixedChecks)
}
...
func TestMixedLawsCanSaturate(t *testing.T) {
	...
	monotonicreadstest.MixedModelSaturation(t, func() monotonicreadstest.Mixed { return monotonicreadstest.NewInMemory() })
}
