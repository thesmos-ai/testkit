...
type MixedStoreStub struct {
	*stub.MethodStub[MixedStoreCall]
	...
	fn       func(context.Context, monotonicreads.Value) error
...
func (s *MixedStoreStub) Func(fn func(context.Context, monotonicreads.Value) error) *MixedStoreStub {
	s.fn = fn
	return s
}
...
type MixedGetStub struct {
	*stub.MethodStub[MixedGetCall]
	...
	fn       func(context.Context, string) (monotonicreads.Value, error)
...
// override and an injected fault both take precedence over it.
func (s *MixedGetStub) Returns(result monotonicreads.Value, err error) *MixedGetStub {
...
// arguments. An injected fault still takes precedence.
func (s *MixedGetStub) Func(fn func(context.Context, string) (monotonicreads.Value, error)) *MixedGetStub {
	s.fn = fn
	return s
}
...
func MixedStubDelegateTo(impl monotonicreads.Mixed) MixedStubOption {
...
func WithMixedStore(fn func(context.Context, monotonicreads.Value) error) MixedStubOption {
...
// time, for the common case of configuring one method and taking the
// defaults for the rest.
func WithMixedGet(fn func(context.Context, string) (monotonicreads.Value, error)) MixedStubOption {
...
var _ monotonicreads.Mixed = (*MixedStub)(nil)
...
func (s *MixedStoreStub) invoke(ctx context.Context, v monotonicreads.Value) func() MixedStoreReturn {
	if s.fn == nil {
		return nil
	}
...
// restated per method.
func (s *MixedStub) Store(ctx context.Context, v monotonicreads.Value) error {
...
// resolves a call the same way and the ordering is tested once rather than
// restated per method.
func (s *MixedStub) Get(ctx context.Context, key string) (monotonicreads.Value, error) {
...
// testkit:provenance a4c013ce0b9d749f47a01915868f26d1d264713d3211e688d685e9dbea581096
