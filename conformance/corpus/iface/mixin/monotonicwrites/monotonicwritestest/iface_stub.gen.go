...
type MixedGetStub struct {
	*stub.MethodStub[MixedGetCall]
	...
	fn       func(context.Context, string) (monotonicwrites.Value, error)
...
// override and an injected fault both take precedence over it.
func (s *MixedGetStub) Returns(result monotonicwrites.Value, err error) *MixedGetStub {
...
// arguments. An injected fault still takes precedence.
func (s *MixedGetStub) Func(fn func(context.Context, string) (monotonicwrites.Value, error)) *MixedGetStub {
	s.fn = fn
	return s
}
...
func MixedStubDelegateTo(impl monotonicwrites.Mixed) MixedStubOption {
...
// time, for the common case of configuring one method and taking the
// defaults for the rest.
func WithMixedGet(fn func(context.Context, string) (monotonicwrites.Value, error)) MixedStubOption {
...
var _ monotonicwrites.Mixed = (*MixedStub)(nil)
...
func (s *MixedStoreStub) invoke(ctx context.Context, v monotonicwrites.Value) func() MixedStoreReturn {
	if s.fn == nil {
		return nil
	}
...
// resolves a call the same way and the ordering is tested once rather than
// restated per method.
func (s *MixedStub) Get(ctx context.Context, key string) (monotonicwrites.Value, error) {
