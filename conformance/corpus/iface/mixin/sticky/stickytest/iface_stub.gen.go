...
type MixedStoreStub struct {
	*stub.MethodStub[MixedStoreCall]
	...
	fn       func(context.Context, sticky.Value) error
...
func (s *MixedStoreStub) Func(fn func(context.Context, sticky.Value) error) *MixedStoreStub {
	s.fn = fn
	return s
}
...
type MixedGetStub struct {
	*stub.MethodStub[MixedGetCall]
	...
	fn       func(context.Context, string) (sticky.Value, error)
...
// override and an injected fault both take precedence over it.
func (s *MixedGetStub) Returns(result sticky.Value, err error) *MixedGetStub {
...
// arguments. An injected fault still takes precedence.
func (s *MixedGetStub) Func(fn func(context.Context, string) (sticky.Value, error)) *MixedGetStub {
	s.fn = fn
	return s
}
...
func MixedStubDelegateTo(impl sticky.Mixed) MixedStubOption {
...
func WithMixedStore(fn func(context.Context, sticky.Value) error) MixedStubOption {
...
// time, for the common case of configuring one method and taking the
// defaults for the rest.
func WithMixedGet(fn func(context.Context, string) (sticky.Value, error)) MixedStubOption {
...
var _ sticky.Mixed = (*MixedStub)(nil)
...
func (s *MixedStoreStub) invoke(ctx context.Context, v sticky.Value) func() MixedStoreReturn {
	if s.fn == nil {
		return nil
	}
...
// restated per method.
func (s *MixedStub) Store(ctx context.Context, v sticky.Value) error {
...
// resolves a call the same way and the ordering is tested once rather than
// restated per method.
func (s *MixedStub) Get(ctx context.Context, key string) (sticky.Value, error) {
