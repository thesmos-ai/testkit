...
func (c MixedCheck) bind(
	...
	fields += ", Prop, PropStore, PropLoad"
	if c.Prop != nil {
		scoped = true
		bodies++
	...
	if c.PropLoad != nil {
		bodies++
		out.ID = suite.MethodID(mixedLoad, c.Name)
		fn := c.PropLoad
		out.RunWith = func(tb testing.TB, sub suite.Subject[Mixed]) {
			model.Check(tb, func(rt *PropT) {
...
// testkit:provenance 7a85ee4cfd65b9486d874a9f93e4c0285906d3010e8f44abddc299b5dc081d02
