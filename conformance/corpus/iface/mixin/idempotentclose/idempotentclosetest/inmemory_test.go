...
// TestCloserLawsCanSaturate drives each bound law against defects worn on
...
func TestCloserLawsCanSaturate(t *testing.T) {
	t.Parallel()

	idempotentclosetest.CloserModelSaturation(t, func() idempotentclosetest.Closer { return idempotentclosetest.NewInMemory() })
}
