...
// mixedAssertGetMiss asserts Get reports ErrNotFound for a key nothing wrote.
			...
			func(tb testing.TB) Mixed {
				return NewMixedStub(tb, WithMixedGet(
					func(_ context.Context, _ string) (r0 string, err error) {
						...
						r0 = "other-"
						err = errors2.New("planted: Get refused with a believable value")
						return
					}))
			}),
...
// testkit:provenance 53291b6adee36aaea7ff5ea5435fcf28a9ee834bda0f2db43c401f10ce2d2d13
