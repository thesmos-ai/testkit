...
// TestStreamReaderLawsCanSaturate drives each bound law against defects worn on
...
func TestStreamReaderLawsCanSaturate(t *testing.T) {
	t.Parallel()

	streamreadertest.StreamReaderModelSaturation(t, func() streamreadertest.StreamReader { return streamreadertest.NewInMemory() })
}
