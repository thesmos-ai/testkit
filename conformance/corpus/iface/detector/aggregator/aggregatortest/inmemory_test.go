...
// TestAggregatorLawsCanSaturate drives each bound law against defects worn on
...
func TestAggregatorLawsCanSaturate(t *testing.T) {
	t.Parallel()

	aggregatortest.AggregatorModelSaturation(t, func() aggregatortest.Aggregator { return aggregatortest.NewInMemory() })
}
