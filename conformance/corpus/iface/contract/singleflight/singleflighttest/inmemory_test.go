...
func TestContractChecksCanFail(t *testing.T) {
	...
	singleflighttest.ProveContract(t, contractChecks)
}
...
func TestContractLawsCanSaturate(t *testing.T) {
	...
	singleflighttest.ContractModelSaturation(t, func() singleflighttest.Contract { return singleflighttest.NewInMemory() })
}
