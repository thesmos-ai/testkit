...
type ContractPutStub struct {
	*stub.MethodStub[ContractPutCall]
	...
	fn       func(context.Context, persister.Value) error
...
func (s *ContractPutStub) Func(fn func(context.Context, persister.Value) error) *ContractPutStub {
	s.fn = fn
	return s
}
...
type ContractGetStub struct {
	*stub.MethodStub[ContractGetCall]
	...
	fn       func(context.Context, string) (persister.Value, error)
...
// override and an injected fault both take precedence over it.
func (s *ContractGetStub) Returns(result persister.Value, err error) *ContractGetStub {
...
// arguments. An injected fault still takes precedence.
func (s *ContractGetStub) Func(fn func(context.Context, string) (persister.Value, error)) *ContractGetStub {
	s.fn = fn
	return s
}
...
func ContractStubDelegateTo(impl persister.Contract) ContractStubOption {
...
func WithContractPut(fn func(context.Context, persister.Value) error) ContractStubOption {
...
// time, for the common case of configuring one method and taking the
// defaults for the rest.
func WithContractGet(fn func(context.Context, string) (persister.Value, error)) ContractStubOption {
...
func (s *ContractPutStub) invoke(ctx context.Context, v persister.Value) func() ContractPutReturn {
	if s.fn == nil {
		return nil
	}
...
// restated per method.
func (s *ContractStub) Put(ctx context.Context, v persister.Value) error {
...
// resolves a call the same way and the ordering is tested once rather than
// restated per method.
func (s *ContractStub) Get(ctx context.Context, key string) (persister.Value, error) {
...
// FaultMediumGone makes the next call to Put fail with
// ErrMediumGone.
//
...
func (s *ContractPutStub) FaultMediumGone() *ContractPutStub {
	s.Faults(persister.ErrMediumGone, 1)
	return s
}

// testkit: end of generated content.
// testkit:provenance 28cf92e3c6250b32da922d85cc384009112ba695a112cf8d3c04acd27d3f9e79
