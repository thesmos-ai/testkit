...
type ContractCheck struct {
	...
	PropPublish func(rt *PropT, s Contract, value publisher.Value)
}
...
func contractProofs() prove.Defects[Contract] {
	...
	return prove.Defects[Contract]{
		ix.Publish.Smoke(): prove.One("a Contract whose Publish panics",
			func(tb testing.TB) Contract {
				return NewContractStub(tb, WithContractPublish(
					func(_ context.Context, _ publisher.Value) error {
		...
		ix.Publish.Cancels(): prove.One("a Contract whose Publish ignores the context it is handed",
			func(tb testing.TB) Contract {
				return NewContractStub(tb, WithContractPublish(
					func(_ context.Context, _ publisher.Value) (err error) {
		...
		ix.Subscribe.Smoke(): prove.One("a Contract whose Subscribe panics",
			func(tb testing.TB) Contract {
				return NewContractStub(tb, WithContractSubscribe(
					func(_ context.Context) (<-chan publisher.Value, error) {
		...
		ix.Subscribe.Cancels(): prove.One("a Contract whose Subscribe ignores the context it is handed",
			func(tb testing.TB) Contract {
				return NewContractStub(tb, WithContractSubscribe(
					func(_ context.Context) (r0 <-chan publisher.Value, err error) {
						// The call arrives and nothing is done with it; the bare
						// return answers every slot's zero, which for the error
						// slot is the nil this claim forbids.
						return
...
type contractModelReference struct {
	store *ref.FanOut[publisher.Value]
}
...
func NewContractModelReference() Contract {
	return &contractModelReference{store: ref.NewFanOut[publisher.Value]()}
}

func (r *contractModelReference) Publish(ctx context.Context, v publisher.Value) error {
	return r.store.Publish(ctx, v)
}

func (r *contractModelReference) Subscribe(ctx context.Context) (<-chan publisher.Value, error) {
...
func contractModelActions(fx ContractFixture) []model.Action[Contract] {
	...
	out = append(out, action.NewDelivery[Contract, publisher.Value](
		"Publish",
		func(ctx context.Context, s Contract) (<-chan publisher.Value, error) {
			return s.Subscribe(ctx)
		},
		func(ctx context.Context, s Contract, m publisher.Value) error {
