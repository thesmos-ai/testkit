...
type ContractPutStub struct {
	*stub.MethodStub[ContractPutCall]
	...
	fn       func(context.Context, ifmatch.Value) error
...
func (s *ContractPutStub) Func(fn func(context.Context, ifmatch.Value) error) *ContractPutStub {
	s.fn = fn
	return s
}
...
func WithContractPut(fn func(context.Context, ifmatch.Value) error) ContractStubOption {
...
var _ ifmatch.Contract = (*ContractStub)(nil)
...
func (s *ContractPutStub) invoke(ctx context.Context, v ifmatch.Value) func() ContractPutReturn {
	if s.fn == nil {
		return nil
	}
...
// restated per method.
func (s *ContractStub) Put(ctx context.Context, v ifmatch.Value) error {
...
// testkit:provenance 99adf7e2693cbf943dab5ace73700fe40aeef3af5f7ab14b91c896022bbf70e1
