...
type ContractPutStub struct {
	*stub.MethodStub[ContractPutCall]
	...
	fn       func(context.Context, batchwriter.Value) error
...
func (s *ContractPutStub) Func(fn func(context.Context, batchwriter.Value) error) *ContractPutStub {
	s.fn = fn
	return s
}
...
type ContractGetStub struct {
	*stub.MethodStub[ContractGetCall]
	...
	fn       func(context.Context, string) (batchwriter.Value, error)
...
// override and an injected fault both take precedence over it.
func (s *ContractGetStub) Returns(result batchwriter.Value, err error) *ContractGetStub {
...
// arguments. An injected fault still takes precedence.
func (s *ContractGetStub) Func(fn func(context.Context, string) (batchwriter.Value, error)) *ContractGetStub {
	s.fn = fn
	return s
}
...
func ContractStubDelegateTo(impl batchwriter.Contract) ContractStubOption {
...
func WithContractPut(fn func(context.Context, batchwriter.Value) error) ContractStubOption {
...
// time, for the common case of configuring one method and taking the
// defaults for the rest.
func WithContractGet(fn func(context.Context, string) (batchwriter.Value, error)) ContractStubOption {
...
func (s *ContractPutStub) invoke(ctx context.Context, v batchwriter.Value) func() ContractPutReturn {
	if s.fn == nil {
		return nil
	}
...
// restated per method.
func (s *ContractStub) Put(ctx context.Context, v batchwriter.Value) error {
...
// resolves a call the same way and the ordering is tested once rather than
// restated per method.
func (s *ContractStub) Get(ctx context.Context, key string) (batchwriter.Value, error) {
...
// testkit:provenance 27770737f6add4146fc629aef3c2736128a33db54f77ec6c62063c9b1a2b1742
