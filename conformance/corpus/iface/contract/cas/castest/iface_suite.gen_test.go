...
func TestContractProofs(t *testing.T) {
	t.Parallel()
	prove.All(t,
		castest.ContractSuite.Suite(castest.DefaultContractFixture()).Checks,
		contractProofs())
}
...
func contractProofs() prove.Defects[castest.Contract] {
	ix := castest.ContractSuite.Checks
	return prove.Defects[castest.Contract]{
...
func TestContractInvariants(t *testing.T) {
	...
	s := castest.ContractSuite.Suite(castest.DefaultContractFixture())
	...
	suite.VerifyIndex(t, "Contract",
		castest.ContractSuite.Checks.All(), s.IDs())
