...
func (c ContractCheck) bind(
	...
	if c.PropRun != nil {
		bodies++
		out.ID = suite.MethodID(contractRun, c.Name)
		fn := c.PropRun
		out.RunWith = func(tb testing.TB, sub suite.Subject[Contract]) {
			model.Check(tb, func(rt *PropT) {
	...
	if c.PropState != nil {
		bodies++
		out.ID = suite.MethodID(contractState, c.Name)
		fn := c.PropState
		out.RunWith = func(tb testing.TB, sub suite.Subject[Contract]) {
			model.Check(tb, func(rt *PropT) {
...
// testkit:provenance 4e129fe5572f54af62514ac54bda176b75e5d2224af85c284df45e5490044352
