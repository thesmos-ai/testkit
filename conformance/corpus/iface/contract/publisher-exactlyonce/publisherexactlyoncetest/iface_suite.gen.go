...
func (c ContractCheck) bind(
	...
	fields += ", Prop, PropPublish, PropReplay"
	if c.Prop != nil {
		scoped = true
		bodies++
	...
	if c.PropReplay != nil {
		bodies++
		out.ID = suite.MethodID(contractReplay, c.Name)
		fn := c.PropReplay
		out.RunWith = func(tb testing.TB, sub suite.Subject[Contract]) {
			model.Check(tb, func(rt *PropT) {
				fn(rt, sub.New(tb), contractModelValues(fx).Draw(rt, "value"))
...
// testkit:provenance 67914a765c66193a31c03b587c57f5258966c769c884960270155e729a0dc690
