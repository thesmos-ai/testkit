...
func contractNewFixture() ContractFixture {
	return ContractFixture{
		value:      ifabsent.Value{Key: "test-key", Body: "test-body"},
		valueOther: ifabsent.Value{Key: "other-key", Body: "other-body"},
	}
}

// Value is the value the checks call your implementation with.
func (f ContractFixture) Value() ifabsent.Value { return f.value }
...
func (f ContractFixture) ValueOther() ifabsent.Value { return f.valueOther }
...
type Contract = ifabsent.Contract
...
// testkit:provenance 93ff3759ebb25c9022509227228d6aed6fe1d3c8520100df2c9e33d72d48b51e
